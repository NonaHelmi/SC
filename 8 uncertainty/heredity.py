...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] == None:
            person_probability *= PROBS["gene"][person_genetic]
        else:
            ...
            if person_genetic == 2:
                person_probability *= mother_pass * father_pass
            elif person_genetic == 1:
                person_probability *= (1 - mother_pass) * father_pass + \
                    mother_pass * (1 - father_pass)
            else:
                person_probability *= (1 - mother_pass) * (1 - father_pass)

        if person in have_trait:
            person_probability *= PROBS["trait"][person_genetic][True]
        else:
            person_probability *= PROBS["trait"][person_genetic][False]
